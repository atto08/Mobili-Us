package com.project.MobiliUs.config;

import com.project.MobiliUs.jwt.JwtAuthFilter;
import com.project.MobiliUs.jwt.TokenProvider;
...
public class WebMvcConfig extends SecurityConfigurerAdapter<DefaultSecurityFilterChain, HttpSecurity>
    ...
    public void addCorsMappings(CorsRegistry registry) {
        registry.addMapping("/**")
                .allowedOrigins("http://localhost:3000","http://mobilli-us.com","http://mobili-us.shop")
...
//                        .anyRequest().authenticated())
        ...
        httpSecurity.cors().and().csrf().disable()
                ...
                //security 는 기본적으로 세션을 사용하나 본 프로젝트에서는 세션을 사용하지 않으므로 세션 설정을 Stateless 로 변경.
                .and()
                .sessionManagement()
